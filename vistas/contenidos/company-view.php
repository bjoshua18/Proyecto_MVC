						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" type="text" name="nombre-reg"
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group label-floating">
									...
									<input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,50}" class="form-control" type="text" name="director-reg"
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input pattern="[0-9]{4,4}" class="form-control" type="text" name="year-reg" required=""
										maxlength="4">
								</div>
							</div>
						</div>
