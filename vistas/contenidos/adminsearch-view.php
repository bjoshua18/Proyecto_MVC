		...
		<div class="row">
			<div class="col-xs-12 col-md-8 col-md-offset-2">
				<div class="form-group label-floating">
					...
					<input class="form-control" type="text" name="busqueda_inicial_admin" required="" autocomplete="off">
				</div>
			</div>
			<div class="col-xs-12">
				<p class="text-center">
					<button type="submit" class="btn btn-primary btn-raised btn-sm"><i class="zmdi zmdi-search"></i> &nbsp;
						Buscar</button>
				</p>
			</div>
		</div>
...
<div class="container-fluid">
	<form class="well" method="POST" action="">
		<p class="lead text-center">Su última búsqueda fue <strong>“<?= $_SESSION['busqueda_admin'] ?>”</strong></p>
		<div class="row">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<?php
				...
				echo $insAdmin->paginador_administrador_controlador(isset($pagina[1]) ? $pagina[1]: 1, 10, $_SESSION['privilegio_sbp'], $_SESSION['codigo_cuenta_sbp'], $_SESSION['busqueda_admin']);
			?>
