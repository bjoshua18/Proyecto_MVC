...
<?php
	...
	// Comprobamos que accedemos como admin o user
		...
		<div class="panel-body">
			<form action="<?php echo SERVERURL; ?>ajax/cuentaAjax.php" method="POST" data-form="update" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
				...
				?>
					...
					<input type="hidden" name="CodigoCuenta-up" value="<?= $datos[2] ?>">
					<input type="hidden" name="tipoCuenta-up" value="<?= $lc->encryption($datos[1]) ?>">
		    	<fieldset>
